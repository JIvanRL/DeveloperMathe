...
<body> 
  ...
  <div class="row header">
    ...
    <div class="col-md-4">
      ...
      <a href="index.php" style="position: relative; left: -40px;" class="pull-right btn sub1 title3"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Inicio</a>&nbsp;
    </div>
  </div>
  ...
  <div class="bg1">
    <div class="row">
      ...
      <div class="col-md-6 panel" style="background-image:url(image/bg1.jpg); min-height:430px;  left: -330px;">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Mauricio Sevilla Britto</a>
              ...
              <h4 style="font-family:'typo' ">Instituto ConfiguroWeb</h4>
            </div>
          </div>
          </p>
        </div>
